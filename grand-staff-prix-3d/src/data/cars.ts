...
export const CARS: CarSpec[] = [
  { id: 'vortex', name: 'Vortex GT', color: '#FF4E2E', accent: '#2A1410', speed: 0.7, grip: 0.7, topSpeedMul: 1.0, turnMul: 1.0, model: '/models/user_sportscar.glb', modelRotation: Math.PI / 2, openCockpit: true, driverSeat: [0, 0.55, 0.15], driverScale: 1, driverRotation: Math.PI / 2 },
