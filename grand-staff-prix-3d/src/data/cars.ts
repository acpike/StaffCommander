...
export const CARS: CarSpec[] = [
  ...
  { id: 'rumble', name: 'Rumble Rod', color: '#E84CA0', accent: '#3A0B26', speed: 0.8, grip: 0.75, topSpeedMul: 1.05, turnMul: 1.0, model: '/models/car_rumble.glb', modelRotation: Math.PI / 2, openCockpit: true, driverSeat: [0, 0.6, 0.1] },
]
