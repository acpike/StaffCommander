...
// Cloud-synced player rows. `data` holds the progress blob (xp, gems, best,
// unlocked, mastered, achievements, carId, composerId, avatar). A `class_code`
// groups players so the same roster loads on any device (teacher app ↔ student).
...
/** Class leaderboard, highest XP first. */
